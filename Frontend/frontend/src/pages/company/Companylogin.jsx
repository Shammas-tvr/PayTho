...
function CompanyLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    if (!form.company_code || !form.username || !form.password) {
    ...
    try {
      ...
      const res = await axios.post(
        "http://127.0.0.1:8000/api/accounts/company-login/",
        {
      ...
      if (res.data.role === "company_admin") navigate("/company/dashboard");
      ...
      <div style={styles.card}>
        ...
        <div style={styles.brand}>
          ...
          <div>
            ...
            <div style={styles.brandSub}>Company Portal</div>
          </div>
        </div>

        <h2 style={styles.title}>Welcome back</h2>
        <p style={styles.tagline}>Sign in with your company credentials</p>
